    ...
    <div className="flex min-h-screen flex-col bg-[#201d1d] font-[var(--font-plex-mono,var(--font-geist-mono,monospace))] text-[#fdfcfc]">
      <div className="flex flex-1">
        ...
        <div className="flex flex-1 flex-col">
          {/* Breadcrumb bar */}
          <header className="border-b border-[rgba(15,0,0,0.12)] px-8 py-4">
            <Breadcrumbs />
          </header>

          {/* Page content */}
          <main className="mx-auto w-full max-w-[780px] flex-1 px-8 py-10">
            <div
              className={[
                "prose prose-invert max-w-none",
                // Typography overrides for design system
